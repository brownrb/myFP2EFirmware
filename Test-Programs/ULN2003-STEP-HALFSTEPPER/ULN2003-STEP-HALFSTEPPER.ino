...
void setup()
{
  ...
  driverboard = new DriverBoard(PRO2EULN2003, String(programName), STEP1, FAST, IN1ULN, IN2ULN, IN3ULN, IN4ULN);
...
{
  int i;
  Serial.println("ULN2003 Stepper Motor Test");
  Serial.println("Full Steps: 2048 steps: FAST");
  ...
  Serial.println("ULN2003 Stepper Motor Test");
  Serial.println("HALF Steps: 2048 steps: SLOW");
